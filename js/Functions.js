...
console.log("expected value: False", isTwo(1));
console.log("expected value: True", isTwo(2));
console.log("expected value: False", isTwo(3));
/**
 * TODO:
 ...
 */
function calculatorTip(num1,num2){
   return num1 * num2;
}
...
alert("Your tip amount will be $" + calculatorTip(tipTotal,billTotal));
